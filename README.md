...
Написаний на класичному стеку Java EE (Servlets, JSP, JDBC)
без використання складних фреймворків (завдання для 1-го курсу).
...
## Як запустити проєкт
1. Встановіть PostgreSQL та створіть базу даних `event-board`.
...
3. Відкрийте файл `src/main/java/repository/EventRepository.java` та змініть пароль  на свій.
